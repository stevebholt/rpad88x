...
spring. First-year students register for PAD 881 (fall) and PAD 882 (spring), and second-year students register for PAD 883 (fall) and PAD 884 (spring).

### Learning Objectives
The RPAD 88X series introduces public affairs students to the principles, practices, and professional skills required for success in graduate studies, academia, and other research-intensive public affairs careers. The series has several overarching goals: 1) to familiarize students with basic norms and customs in graduate studies and the academy; 2) to help students learn what succes in graduate studies and academia typicall entails, and; 3) to aquaint students with various strategies and skills fundamental in the transition from student to independent scholars.
...
|:-: | :--------------------------- |
| :man_teacher: | Lecture |
| :zap: | Lightening Round with Faculty (serves as link to details) |
| :handbag: | Rockefeller Brown Bag |
| :date: | Assignment due (serves as link to details) |
...
| :-----: | :-----: | :-----: | :-----: |
| 8/26 | Introductions | Approaching Your PhD <br/> :book: Chapter 5 | Sharing Experience <br/> :book: Chapter 2 |
| 9/1 | :handbag: | | |
...
As a condition for reaching candidacy, by the end of your second year, you should plan on completing a literature review. In the class Zotero, there is a collection of literature review help materials. I will also be adding additional material on preparing literature reviews throughout the year. One thing to notice - the literature review advice materials are from a variety of disciplinary backgrounds with a variety of different purposes and approaches reflecting the multidisciplinary nature of the faculty here in Rockefeller College. Your advisor (who will also be the chair of your candidacy committee) will lay out many of the expectations they have of the literature review assignment. By the end of the semester, you will need to submit a draft concept sheet that lays out your plan for your literature review to both me and your advisor. You can find an example concept sheet [here](https://stevebholt.github.io/rpad88x/assets/documents/sample_concept_sheet.pdf). I strongly recommend reading the literature review materials in the Zotero as early in the semester as possible, examining the example that you will be using to complete the assignment, and then making an appointment with your advisor to discuss their expectations for the literature review assignment. This will help make sure your draft literature review concept sheet is as close to planning out an assignment consistent with their expectations as possible. 

### Empirical Paper concept sheet
A second condition for reaching candidacy, by the end of your second year, is the completion of an empirical paper. An empirical paper is typically a study you have worked on yourself (sometimes building on work you have done in class and molding it into a more complete manuscript and sometimes simply something you've done specifically for the assignment). As with the literature review, the empirical paper expectations will vary greatly by the faculty you are working with and the kind of research you are doing. I again suggest meeting with your advisor early to discuss their expectations of the empirical paper to help inform your draft concept sheet for the empirical paper in this class. The same [sample concept sheet](https://stevebholt.github.io/rpad88x/assets/documents/sample_concept_sheet.pdf) applies for both the literature review and empirical paper because the concept sheet structure is largely the same - the goal is to clarify your thinking about the project and develop an outlined plan for the key elements of it. As with the literature review concept sheet, the draft is due to me **and** your advisor.

## Lightening Rounds
### Public Management Faculty
You'll be introduced to the Dr. Edmund Stazyk, Dr. Ellen Rubin, and Dr. Hongseok Lee. Together, they make up the bulk of the public management faculty who conduct quantitative research. They will introduce themselves, talk a bit about their research and their expectations of students, and discuss their research. 

### Public Policy Faculty
You'll be introduced to Dr. Lucy Sorensen, Dr. Melissa Arnold Lyon, and Dr. Ashley Fox. Together, they make up the bulk of the public policy faculty. They will introduce themselves, talk a bit about their research and their expectations of students, and discuss their research.

### Qualitative and Non-Profit Research
